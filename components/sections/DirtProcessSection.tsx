...
export function DirtProcessSection({
  ...
  return (
    <section className="pb-4 md:pb-8 pt-16 lg:pt-20 px-5 lg:px-8 bg-dirt-off-white" style={{ gridColumn: "1 / -1" }}>
      {/*<div className="max-w-7xl mx-auto">*/}
        ...
        {/* Process Steps */}
        <div className="mx-auto flex flex-col gap-4 xl:gap-12 max-w-350">
          {steps}
        </div>
